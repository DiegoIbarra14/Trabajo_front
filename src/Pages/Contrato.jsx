...
const Contrato = () => {
  ...
  const header = (
    <div className="table-header">
      <h5 className="mx-0 my-1 fontGeneral">Gestionar Contrato</h5>
      <span className="p-input-icon-left" style={{ marginLeft: '-19px' }}>
    ...
    <div className="layout ">
      ...
      <div className="content">
        ...
        <div className="card crud">
          ...
          <h1 className="fontGeneral">GESTIONAR CONTRATOS</h1>
          <DataTable
            value={clientes}
            paginator
            rows={10}
          ...
          >
            <Column field="id" className="fontGeneral" header="ID" sortable style={{ minWidth: '4rem' }}></Column>
            <Column field="nombres_completos" className="fontGeneral" header="Nombres Completos" sortable style={{ minWidth: '12rem' }}></Column>
            <Column field="DNI" header="DNI" className="fontGeneral" sortable style={{ minWidth: '12rem' }}></Column>
            <Column field="direccion" header="Dirección" className="fontGeneral" sortable style={{ minWidth: '12rem' }}></Column>
            <Column field="genero" header="Género" className="fontGeneral" sortable style={{ minWidth: '8rem' }}></Column>
            <Column field="celular" header="Celular" className="fontGeneral" sortable style={{ minWidth: '10rem' }}></Column>
            <Column field="correo" header="Correo" className="fontGeneral" sortable style={{ minWidth: '12rem' }}></Column>
            <Column
              body={(rowData) => (
                <React.Fragment>
