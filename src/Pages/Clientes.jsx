...
import "../Styles/Login/Clientes.css";
import { clienteContext } from '../Context/ClienteContext';
const Clientes = () => {
    const { clientes, setClientes, cliente, setCliente } = useContext(clienteContext);
    const emptyCliente = {
        id: null,
        nombres_completos: '',
        direccion: '',
    ...
    const header = (
        <div className="table-header">
            <h5 className="mx-0 my-1">Gestionar Clientes</h5>
    ...
    return (
        <div className="layout ">
            ...
            <div className="content">
                ...
                <Dialog visible={false  } style={{ width: '450px' }} header="Detalles del Cliente" modal className="p-fluid" footer={clienteDialogFooter} onHide={hideDialog}>
                    <div className="field">
